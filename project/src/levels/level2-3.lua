...
local level2_3 = {} -- module

-- new level
level2_3.level = Level.new(120, 7) 
...
local restroom2 = Room.new("Infirmary", true, false, true, false)
	Room.addActionSound(restroom2, "sfx/electrocardio.wav")


--server rooms
local server1 = Room.new("Office Restaurant", true, false, false, true)
	Room.addActionSound(server1, "sfx/vaisselle.wav")
...
-- set escape room
Room.setEscape(reception1)

-- set safe room
Room.setSafe(coridor3)
Room.setSafe(coridor4)
Room.setSafe(restaurant2)
...
-- add room to level
Level.addRoom(level2_3.level, toilet1, 4, 1)
Level.addRoom(level2_3.level, reception1, 5, 1)
Level.addRoom(level2_3.level, desk1, 6, 1)
Level.addRoom(level2_3.level, terrace1, 2, 2)
Level.addRoom(level2_3.level, desk2, 3, 2)
Level.addRoom(level2_3.level, desk3, 4, 2)
Level.addRoom(level2_3.level, reception2, 5, 2)
Level.addRoom(level2_3.level, restroom1, 6, 2)
Level.addRoom(level2_3.level, restaurant1, 1, 3)
Level.addRoom(level2_3.level, coridor1, 3, 3)
Level.addRoom(level2_3.level, coridor2, 4, 3)
Level.addRoom(level2_3.level, coridor3, 6, 3)
Level.addRoom(level2_3.level, coridor4, 1, 4)
Level.addRoom(level2_3.level, coridor5, 2, 4)
Level.addRoom(level2_3.level, reception3, 3, 4)
Level.addRoom(level2_3.level, desk4, 4, 4)
Level.addRoom(level2_3.level, desk5, 5, 4)
Level.addRoom(level2_3.level, server1, 6, 4)
Level.addRoom(level2_3.level, restroom2, 1, 5)
Level.addRoom(level2_3.level, toilet2, 2, 5)
Level.addRoom(level2_3.level, reception4, 3, 5)
Level.addRoom(level2_3.level, infirmary1, 4, 5)
Level.addRoom(level2_3.level, infirmary2, 5, 5)
Level.addRoom(level2_3.level, coridor6, 1, 6)
Level.addRoom(level2_3.level, desk6, 3, 6)
Level.addRoom(level2_3.level, coridor7, 4, 6)
Level.addRoom(level2_3.level, coridor8, 5, 6)
Level.addRoom(level2_3.level, terrace2, 6, 6)
Level.addRoom(level2_3.level, server2, 1, 7)
Level.addRoom(level2_3.level, desk7, 2, 7)
Level.addRoom(level2_3.level, desk8, 3, 7)
Level.addRoom(level2_3.level, restaurant2, 5, 7)
