...
-- set escape room
Room.setEscape(restaurant2)

-- set safe room
Room.setSafe(desk3)
Room.setSafe(coridor6)
...
-- add room to level
Level.addRoom(level2_4.level, toilet1, 4, 1)
Level.addRoom(level2_4.level, reception1, 5, 1)
Level.addRoom(level2_4.level, desk1, 6, 1)
Level.addRoom(level2_4.level, terrace1, 2, 2)
Level.addRoom(level2_4.level, desk2, 3, 2)
Level.addRoom(level2_4.level, desk3, 4, 2)
Level.addRoom(level2_4.level, reception2, 5, 2)
Level.addRoom(level2_4.level, restroom1, 6, 2)
Level.addRoom(level2_4.level, restaurant1, 1, 3)
Level.addRoom(level2_4.level, coridor1, 3, 3)
Level.addRoom(level2_4.level, coridor2, 4, 3)
Level.addRoom(level2_4.level, coridor3, 6, 3)
Level.addRoom(level2_4.level, coridor4, 1, 4)
Level.addRoom(level2_4.level, coridor5, 2, 4)
Level.addRoom(level2_4.level, reception3, 3, 4)
Level.addRoom(level2_4.level, desk4, 4, 4)
Level.addRoom(level2_4.level, desk5, 5, 4)
Level.addRoom(level2_4.level, server1, 6, 4)
Level.addRoom(level2_4.level, restroom2, 1, 5)
Level.addRoom(level2_4.level, toilet2, 2, 5)
Level.addRoom(level2_4.level, reception4, 3, 5)
Level.addRoom(level2_4.level, infirmary1, 4, 5)
Level.addRoom(level2_4.level, infirmary2, 5, 5)
Level.addRoom(level2_4.level, coridor6, 1, 6)
Level.addRoom(level2_4.level, desk6, 3, 6)
Level.addRoom(level2_4.level, coridor7, 4, 6)
Level.addRoom(level2_4.level, coridor8, 5, 6)
Level.addRoom(level2_4.level, terrace2, 6, 6)
Level.addRoom(level2_4.level, server2, 1, 7)
Level.addRoom(level2_4.level, desk7, 2, 7)
Level.addRoom(level2_4.level, desk8, 3, 7)
Level.addRoom(level2_4.level, restaurant2, 5, 7)
